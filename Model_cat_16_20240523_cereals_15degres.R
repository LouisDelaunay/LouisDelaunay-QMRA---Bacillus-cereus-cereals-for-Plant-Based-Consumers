...
muopt_Bc3_P <- 2.05 # µopt for tubers and lentils - Combase ID: Car_45 ; pH 6.5 ; temperature 30; G= 0.346 µ = 2.05 #FRENCH - on pourrait supprimer cette information qui n'est pas utilisée par la suite
z_Bc3       <- 6.2
D90_Bc3     <- 101.9
...
muopt_Bc4_P <- 2.05 # µopt for tubers and lentils - Combase ID: Car_45 ; pH 6.5 ; temperature 30; G= 0.346 µ = 2.05 #FRENCH - on pourrait supprimer cette information qui n'est pas utilisée par la suite
z_Bc4       <- 7.128
D100_Bc4    <- 6.08
...
pct_Bc_inf_2log_C <- (N_inf_2log/(N_inf_2log + N_sup_2log))/100
...
pct_Bc_sup_2log_C <- (N_sup_2log/(N_inf_2log + N_sup_2log))/100
...
#FRENCH - pour moi, il manque ici la pondération par les proportions d'individus pour chaque pratique
...
N_24h_nofridge_Bc3_C <- N_ht_Bc3_C*exp(muopt_Bc3_C*gamma_cooling_Bc3_C*(24-lag_cooling)) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde

###------ 24h growth for group IV B. cereus
N_24h_nofridge_Bc4_C <- N_ht_Bc4_C*exp(muopt_Bc4_C*gamma_cooling_Bc4_C*(24-lag_cooling)) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
...
##----- Group III B. cereus
###------ 24h growth
N_24h_Bc3_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc3_C, ifelse(24<lag_storage, N_cooling_time_Bc3_C, N_cooling_time_Bc3_C*exp(muopt_Bc3_C*gamma_fridge_Bc3*(24-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 48h growth
N_48h_Bc3_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc3_C, ifelse(48<lag_storage, N_cooling_time_Bc3_C, N_cooling_time_Bc3_C*exp(muopt_Bc3_C*gamma_fridge_Bc3*(48-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 72h growth
N_72h_Bc3_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc3_C, ifelse(72<lag_storage, N_cooling_time_Bc3_C, N_cooling_time_Bc3_C*exp(muopt_Bc3_C*gamma_fridge_Bc3*(72-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 96h growth
N_96h_Bc3_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc3_C, ifelse(96<lag_storage, N_cooling_time_Bc3_C, N_cooling_time_Bc3_C*exp(muopt_Bc3_C*gamma_fridge_Bc3*(96-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 120h growth
N_120h_Bc3_C  <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc3_C, ifelse(120<lag_storage, N_cooling_time_Bc3_C, N_cooling_time_Bc3_C*exp(muopt_Bc3_C*gamma_fridge_Bc3*(120-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde


##----- Group IV B. cereus
###------ 24h growth
N_24h_Bc4_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc4_C, ifelse(24<lag_storage, N_cooling_time_Bc4_C, N_cooling_time_Bc4_C*exp(muopt_Bc4_C*gamma_fridge_Bc4*(24-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 48h growth
N_48h_Bc4_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc4_C, ifelse(48<lag_storage, N_cooling_time_Bc4_C, N_cooling_time_Bc4_C*exp(muopt_Bc4_C*gamma_fridge_Bc4*(48-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 72h growth
N_72h_Bc4_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc4_C, ifelse(72<lag_storage, N_cooling_time_Bc4_C, N_cooling_time_Bc4_C*exp(muopt_Bc4_C*gamma_fridge_Bc4*(72-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 96h growth
N_96h_Bc4_C   <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc4_C, ifelse(96<lag_storage, N_cooling_time_Bc4_C, N_cooling_time_Bc4_C*exp(muopt_Bc4_C*gamma_fridge_Bc4*(96-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde
###------ 120h growth
N_120h_Bc4_C  <- ifelse(T_frigde<T_lagtime_gt1week, N_cooling_time_Bc4_C, ifelse(120<lag_storage, N_cooling_time_Bc4_C, N_cooling_time_Bc4_C*exp(muopt_Bc4_C*gamma_fridge_Bc4*(120-lag_storage)))) #FRENCH - j'ai changé la formule en supprimant le *1/6 pour raisonner à l'échelle du plat jusqu'au bout pour tout le monde


#####Addition des (N_24h_nofridge_Bc3_C + N_24h_nofridge_Bc4_C)/Nb_portions_per_dish/mean_portion_size
...
#---- Calculating risks
risk_hot_C          <- C_ht_Bc_C > cutoff #FRENCH - j'ai changé la formule pour récupérer la quantité de B. cereus par portion (et pas par plat)

risk_24h_C          <- C_24h_Bc_C > cutoff #FRENCH - j'ai changé la formule en divisant par le nbre de portions pour récupérer la quantité de B. cereus par portion (et pas par plat)
risk_48h_C          <- C_48h_Bc_C > cutoff #FRENCH - j'ai changé la formule en divisant par le nbre de portions pour récupérer la quantité de B. cereus par portion (et pas par plat)
risk_72h_C          <- C_72h_Bc_C	> cutoff #FRENCH - j'ai changé la formule en divisant par le nbre de portions pour récupérer la quantité de B. cereus par portion (et pas par plat)
risk_96h_C          <- C_96h_Bc_C > cutoff #FRENCH - j'ai changé la formule en divisant par le nbre de portions pour récupérer la quantité de B. cereus par portion (et pas par plat)
risk_120h_C         <- C_120h_Bc_C > cutoff #FRENCH - j'ai changé la formule en divisant par le nbre de portions pour récupérer la quantité de B. cereus par portion (et pas par plat)

risk_24h_nofridge_C <- C_24h_nofridge_Bc_C > cutoff #FRENCH - j'ai changé la formule pour récupérer la quantité de B. cereus par portion (et pas par plat)
...
mc(prev_Bernoulli_C, T_frigde, Cooling_time, Qty_cat16_day,
  N0_tot_C, C0_tot_Bc_C, C_ht_Bc_C, C_cooling_time_Bc_C, C_24h_Bc_C, C_48h_Bc_C, C_72h_Bc_C, C_96h_Bc_C, C_120h_Bc_C, C_24h_nofridge_Bc_C,
  risk_hot_C, risk_24h_C, risk_48h_C, risk_72h_C, risk_96h_C, risk_120h_C,risk_24h_nofridge_C,risk_portion_fridge_C,
  log_concentration_08_C_5days) #lag_storage, lag_cooling
...
Resu.final_C  <- summary(Resu_C, probs=c(0.5, 0.95, 0.99), lim=c(0.025,0.975))
...
Resu.final_C$N0_tot_C
Resu.final_C$N_ht_Bc_C
Resu.final_C$N_cooling_time_Bc_C
Resu.final_C$N_24h_Bc_C
Resu.final_C$N_48h_Bc_C
Resu.final_C$N_72h_Bc_C
Resu.final_C$N_96h_Bc_C
Resu.final_C$N_120h_Bc_C
Resu.final_C$N_24h_nofridge_Bc_C

Resu.final_C$risk_hot_C
Resu.final_C$risk_24h_C
Resu.final_C$risk_48h_C
Resu.final_C$risk_72h_C
Resu.final_C$risk_96h_C
Resu.final_C$risk_120h_C
Resu.final_C$risk_24h_nofridge_C
Resu.final_C$risk_portion_no_fridge_C
Resu.final_C$risk_portion_hot_C
Resu.final_C$risk_portion_fridge_C
...
save.image("C:/Users/SECALIM20221/Desktop/recherche/Projets/Thes_Pauline_Mombert/Publi/Major_revision_V2/Results/Model cereals full 200000 20240523.RData")
